//The Naive pattern-searching algorithm doesn’t work well
// in cases where we see many matching characters followed by a mismatching character.
//tc--> o(n+m)--> in worst case else o(n) ;
